...
class DBHelper:
    ...
    def get_calendar_by_region(self, region_id, today):
        return self.cursor.execute('select * from ramadan_calendar where region_id=? and r_date=?', (region_id, today)).fetchone()
